...
export default function PrivacyPage({ params }: Props) {
  ...
  const privacy = getCopy(locale).legal.privacy;
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-400 mt-2">
            {privacy.updatedLabel} {lastUpdated}
          </p>
          <p className="text-gray-300 mt-4 max-w-3xl">{privacy.lead}</p>
        </div>
        ...
        <div className="grid gap-6">
          {privacy.sections.map((section) => (
            <section
              key={section.title}
              className="rounded-2xl border border-blue-500/20 bg-white/5 p-6 shadow-[0_20px_80px_rgba(59,130,246,0.12)] backdrop-blur"
            >
